      ...
      module VM
        module Default
          ...
          def vm_floatingip_add(vm_id:, ip: nil, private_ip: nil)
            action(:vm, :floatingip_add, vm_id: vm_id, ip: ip,
          ...
          def vm_create(hostname:, plan_id:, image_id:, region: nil, ip: nil,
                        net_id: nil, securitygroups: nil, scripts: nil,
                        volume_id: nil, volume_virtio: nil, key_id: nil,
                        set_password: nil, affinity_group: nil)
            action(:vm, :create, hostname: hostname, plan_id: plan_id,
                                 image_id: image_id, region: region, ip: ip,
                                 net_id: net_id, securitygroups: securitygroups,
                                 scripts: scripts, volume_id: volume_id,
                                 volume_virtio: volume_virtio, key_id: key_id,

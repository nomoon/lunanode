    ...
    module Actions
      module Monitor
        module Default
          ...
          def monitor_check_add(name:, type:, fail_count:, success_count:,
                                check_interval:, **from_check_type)
            action(:monitor, :check_add, name: name, type: type,
          ...
          def monitor_alert_add(check_id:, contact_id:)
            action(:monitor, :alert_add, check_id: check_id,
